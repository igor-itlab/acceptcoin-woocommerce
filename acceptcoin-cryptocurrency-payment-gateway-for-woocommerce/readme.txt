...
= Can customers pay with cryptocurrency without registering on my site? =

Your customers do not need an account to pay with cryptocurrencies. They simply scan the payment QR code and enter the required amount for payment. Everything is very simple.

= What cryptocurrency wallet do you support?=

We support over 30 of the most popular cryptocurrencies.

= Can you help me integrate cryptocurrency payments into my website? =

Of course, our support team is always ready to help. Contact us via email <a href="mailto:tech@acceptcoin.io">Contact us by e-mail</a>.

= Where can I obtain information about the paid amount for order? =

You can access details about the paid amount for the transaction in the 'wp_postmeta' table by locating the row using the order ID in the 'post_id' column and the 'wc_acceptcoin_processed_amount' in the 'meta_key' column.
